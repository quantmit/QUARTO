...
## pisode-to-Episode Changes in Viewership

![Episode-to-Episode Changes](https://images.edrawsoft.com/articles/naruto-timeline/naruto-novel-timeline-1.png)

1.  The viewership of the show decreased by 15% between seasons 3 and 5\[\^1\].
2.  The average temperature in the summer months increased by 2.5°C compared to the previous year\[\^2\].
3.  The sales of Product A showed a significant increase of 25% in the third quarter of the year\[\^3\].
